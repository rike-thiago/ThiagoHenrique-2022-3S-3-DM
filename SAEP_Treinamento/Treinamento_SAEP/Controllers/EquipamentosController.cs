...
using Treinamento_SAEP.Data;
using Treinamento_SAEP.Models;

namespace Treinamento_SAEP.Controllers
{
    public class EquipamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Equipamento,Imagem,Descicao,Ativo,Data")] Equipamentos equipamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Equipamento,Imagem,Descicao,Ativo,Data")] Equipamentos equipamentos)
        {
